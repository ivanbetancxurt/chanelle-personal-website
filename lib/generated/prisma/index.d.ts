...
export namespace Prisma {
  ...
  */
  ...
  export type ArticlesOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"link" | "title" | "organization" | "date" | "thumbnail" | "thumbnailDescription", ExtArgs["result"]["articles"]>
  ...
  export interface ArticlesDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `link`
     * const articlesWithLinkOnly = await prisma.articles.findMany({ select: { link: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Articles and only return the `link`
     * const articlesWithLinkOnly = await prisma.articles.createManyAndReturn({
     *   select: { link: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Articles and only return the `link`
     * const articlesWithLinkOnly = await prisma.articles.updateManyAndReturn({
     *   select: { link: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface ArticlesFieldRefs {
    ...
    readonly organization: FieldRef<"Articles", 'String'>
    readonly date: FieldRef<"Articles", 'String'>
    readonly thumbnail: FieldRef<"Articles", 'String'>
    readonly thumbnailDescription: FieldRef<"Articles", 'String'>
  }
  ...
  export type ArticlesWhereInput = {
    ...
    link?: StringFilter<"Articles"> | string
    title?: StringFilter<"Articles"> | string
    organization?: StringFilter<"Articles"> | string
    date?: StringFilter<"Articles"> | string
    thumbnail?: StringFilter<"Articles"> | string
    thumbnailDescription?: StringFilter<"Articles"> | string
  }
  ...
  export type ArticlesOrderByWithRelationInput = {
    ...
    date?: SortOrder
    thumbnail?: SortOrder
    thumbnailDescription?: SortOrder
  }
  ...
  export type ArticlesScalarWhereWithAggregatesInput = {
    ...
    link?: StringWithAggregatesFilter<"Articles"> | string
    title?: StringWithAggregatesFilter<"Articles"> | string
    organization?: StringWithAggregatesFilter<"Articles"> | string
    date?: StringWithAggregatesFilter<"Articles"> | string
    thumbnail?: StringWithAggregatesFilter<"Articles"> | string
    thumbnailDescription?: StringWithAggregatesFilter<"Articles"> | string
  }
  ...
  export type ArticlesUpdateInput = {
    ...
    thumbnailDescription?: StringFieldUpdateOperationsInput | string
  }
